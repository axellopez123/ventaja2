...
const Sidebar = (props) => {
  ...
  return (
    <div
      className={`bg-gradient-to-t from-orange-300 from-50% to-white fixed lg:left-0 top-0 w-28 h-full flex flex-col justify-between py-6 rounded-tr-xl rounded-br-xl z-50 transition-all ${
