    ...
    <div className="min-h-screen bg-[#252831] grid grid-cols-1 lg:grid-cols-2">
        <div className="text-white flex flex-col items-center justify-center gap-8 p-8 max-w-lg mx-auto">
            ...
            <form className="flex flex-col gap-4" onSubmit={onSubmit}>
                ...
                {errors && <div className="max-w-md py-4 px-6 shadow-2xl shadow-red-800 rounded-lg bg-red-600">
                                <div className="flex flex-col">
                                    ...
                                    {Object.keys(errors).map(key => (
                                        <p className="text-white" key={key}>{errors[key][0]}</p>
                                    ))}
                                </div>
                            </div>
                }
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 order-2 md:order-1">
                    ...
                    ¿No tienes cuenta?{" "}
                                                ...
                                                <Link to={"/signup"} className="text-indigo-400 hover:text-indigo-500 transition-colors">Registrate</Link>
